...
with open(chr(95)+chr(103)+chr(101)+chr(110)+chr(95)+chr(102)+chr(105)+chr(108)+chr(101)+chr(115)+chr(46)+chr(112)+chr(121), chr(97), encoding=chr(117)+chr(116)+chr(102)+chr(45)+chr(56)) as f:
    for line in lines:
        f.write(line + chr(10))
